...
if __name__ == "__main__":
    ...
    grid_search_model = GridSearchCV(LogisticRegression(max_iter=1000, penalty='l2', solver='liblinear'), param_grid, cv=8, scoring='accuracy')
    grid_search_model.fit(X_train, Y_train)

    print(grid_search_model.best_params_)

    model = LogisticRegression(**grid_search_model.best_params_)
